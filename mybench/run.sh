...
for nThread in 1 2 4 8 16; do
    ...
    # numactl --cpunodebind=0 --membind=0 ./_build/s3fifo zipf1.0_1_100.oracleGeneral.bin $sz $hp ${nThread} | tail -n 1
